...
public class HttpUtil {
    ...
    private static Header[] headersHandler(Map<String, String> headers) {
        if (headers != null && headers.size() > 0) {
            List<Header> headerList = new ArrayList<>();
            for (Map.Entry<String, String> header : headers.entrySet()) {
                Header headerElement = new BasicHeader(header.getKey(), header.getValue());
                headerList.add(headerElement);
            }
            return (Header[]) headerList.toArray();
        }
        return null;
    }
    ...
    public static String post(String url, Map<String, String> headers, Map<String, String> params) {
        ...
        try {
            ...
            if (headers == null) {
                ...
                httpPost.setHeaders(headersHandler(headers));
            }
            //设置请求参数
            if (params != null) {
    ...
    public static String get(String url, Map<String, String> headers, Map<String, String> params) {
        ...
        try {
            ...
            if (headers == null) {
                ...
                httpGet.setHeaders(headersHandler(headers));
            }
